...
<h1>2. Install a software</h1>
 Download Codeblocks.
 
<h1>3.Create a new project:</h1>
...
<h1>4. Copy TetGen source files</h1>
a)Extract the TetGen package.
b)Copy all extracted files into the project's source file directory (tetgen).
c)Right-click and Add Files: add the header files (.h suffix) and the two source files (.cxx suffix).

<h1>5. Configure Project Properties</h1>
...
<h1>6. Configure Build Options</h1>
a)Right-click and select Build options....;Navigate to the Make commands;Delete all instances of "$target" .
b)Build the Project:Click the Build button (yellow gear icon).Wait a few seconds. If successful, an executable file named tetgen.exe will be generated in the project folder. Compilation is complete!

<h1>7. Test and Verification Phase</h1>
